...
export async function createReactClient(that, parsedJDL) {
    ...
    that.fs.copyTpl(that.templatePath("react/src/components/forms/PasswordField.tsx.ejs"), that.destinationPath(`client/src/components/forms/PasswordField.tsx`), {});
    that.fs.copyTpl(that.templatePath("react/src/components/forms/RadioGroup.tsx.ejs"), that.destinationPath(`client/src/components/forms/RadioGroup.tsx`), {});
